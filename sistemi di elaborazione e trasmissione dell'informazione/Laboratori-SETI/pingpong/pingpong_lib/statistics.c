...
//da controllare il risultato del calcolo (ordine di grandezza, etc)
	// double result_sec, result_nsec;
	// result_sec = last->tv_sec - previous->tv_sec;
	// result_nsec = last->tv_nsec-previous->tv_nsec;
	// if(result_sec<0 && result_nsec<0)
	// 	exit(EXIT_FAILURE);
	// printf("\nbefore ------->%lf + %lf", result_sec, result_nsec);
	// double result = (result_sec*pow(10,3)+result_nsec*pow(10,-6));
	// printf("\nafter------->%lf\n", result);
	// return result;
