package progetto2022_lpo21_49.visitors.typechecking;

import static progetto2022_lpo21_49.visitors.typechecking.SimpleType.*;
...
public class Typecheck implements Visitor<Type> {
	...
	public Type visitSingleExp(Exp single) {
		INT.checkEqual(single.accept(this));
		return INT;
	}

	@Override
	public Type visitWhileStmt(Exp exp, Block thenBlock) {
		BOOL.checkEqual(exp.accept(this));
		thenBlock.accept(this);
		return null;
	}
	...
	@Override
	public SimpleType visitArrayLiteral(ExpSeq expSeq) {
		INT.checkEqual(expSeq.accept(this));
		return ARRAY;
	}
