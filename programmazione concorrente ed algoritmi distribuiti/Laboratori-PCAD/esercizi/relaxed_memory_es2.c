// Not completely sure of how it works and there should be better ways to implement it🥲

// Inserite barriere di memoria per eliminare eventuali anomalie usando la direttiva
// __sync_synchronize()

// vedi http://gcc.gnu.org/onlinedocs/gcc-4.6.2/gcc/Atomic-Builtins.html
