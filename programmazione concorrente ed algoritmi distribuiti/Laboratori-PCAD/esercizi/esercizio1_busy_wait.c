// è logicamente corretto, ma ci sono delle anomalie se l'argomento passato è molto grande...come mai?
// la causa dell'anomalia è il memory model :)
...
// "volatile" è per il compilatore per non cambiare l'ordine d'esecuzione
