//Considerate il codice C con pthread incluso in fondo al testo che implementa  una variante  dell'algoritmo di mutua esclusione di Peterson visto a lezione (1 marzo).

// - Analizzate il codice e provate ad eseguirlo in SW1 o sul vostro laptop per un numero crescente di iterazioni (argomento passato al main). 
// - Provate diverse volte anche con lo stesso numero di iterazioni
#include <pthread.h>
#include <assert.h>
#include <pthread.h>
#include <stdio.h>
