...
class MMN(Simulation):
    ...
    def fifo_schedule(self, job_id) -> int:
        # Choose the queue with the minimum length.
        return min(range(len(self.queues)), key=lambda i: self.queue_len(i))
    ...
    def is_critical(self, job_id) -> bool:
        threshold = 0.3
        random_value = expovariate(self.mu)
...
def main():
    ...
    parser.add_argument("--queue_length_frequency", type=int, default=200)
