package com.example.calculatorrefined;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculate(View view) { // il bottone "=" è stato premuto
        TextView showCalcTextView = findViewById(R.id.showCalculator);
    ...
    @Override
    protected void onSaveInstanceState(@NonNull Bundle outState) { // TODO: NonNull è errore nel caso in cui la calcolatrice sia vuota?
        super.onSaveInstanceState(outState);
        // TODO: aggiungere salvataggio textView
        TextView tv = findViewById(R.id.showCalculator);
        //save textview content
        outState.putString("showCalculator", tv.getText().toString());
