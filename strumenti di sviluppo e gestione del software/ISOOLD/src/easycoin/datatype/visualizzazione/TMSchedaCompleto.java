...
public class TMSchedaCompleto extends EESchedaCompleto {

	protected Id idTM;  //  @jve:decl-index=0:
	protected String descrizione;
	protected String valoreNominale;  //  @jve:decl-index=0:
	protected String fattoreMolt;
	protected String spessore;
	protected String peso;
	protected String bordo;
	protected String dimensione;  //  @jve:decl-index=0:
...
public TMSchedaCompleto(Visualizza v,Id idEE, String nome, String areaGeografica, String nomeOriginale, String dataInizio, String dataFine, String note, Hashtable zecche, Hashtable sistemiMonetari, Id idTM, String descrizione, String valoreNominale, String nomeUnita, String fattoreMolt, String spessore, String peso, String bordo, String dimensione, String forma, String materiale) {
		super(v,idEE, nome, areaGeografica, nomeOriginale, dataInizio, dataFine, note, zecche, sistemiMonetari);
		this.idTM = idTM;
...
public TMSchedaCompleto(Visualizza v, Id idEE, String nome, String areaGeografica, String nomeOriginale, String dataInizio, String dataFine, String note, Hashtable zecche, Hashtable sistemiMonetari) {
	super(v, idEE, nome, areaGeografica, nomeOriginale, dataInizio, dataFine, note,
			zecche, sistemiMonetari);
...
/**
	...
	public void initialize() {
        ...
        this.setLayout(null);
        this.setSize(new Dimension(760, 672));
        //this.add(jL_Id, null);
        ...
        this.setBorder(javax.swing.BorderFactory.createTitledBorder("Tipo Moneta Scheda Completa"));
	}
	/**
